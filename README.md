...
<h4>     🔭 Working on responsive web apps with React and Redux.</h4>
  <h4>👯 Open to collaborating on web development projects.</h4>  
  <h4>     🤝 Seeking help with advanced JavaScript patterns.</h4>  
 <h4>      🌱 Learning state management and server-side rendering.</h4>  
   <h4>    🌱 Learning state management and server-side rendering.</h4>  
   <h4>    💬 Ask me about front-end development with React.</h4>  
   <h4>   ⚡ Fun fact: I enjoy solving logic puzzles!</h4>  
